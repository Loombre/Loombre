...
- **[Linux (rpm / deb / tarball)](linux.md)** — `.rpm` (Fedora, RHEL 9/10, openSUSE), `.deb` (Debian 12/13, Ubuntu 22.04/24.04/26.04 LTS), or a relocatable tarball for any other glibc ≥ 2.34 distro. Bare-metal installs, containers without Docker-in-Docker. Bundled Node, ffmpeg, systemd units, desktop tray controller.
