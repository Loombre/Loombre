...
import * as emailInUseNotice from './email-in-use-notice.js';
...
const RENDERERS: Record<
  'invite' | 'password-reset' | 'security-notice' | 'email-in-use-notice' | 'test',
  (params: Record<string, string>) => RenderedMail
> = {
  invite: invite.render,
  'password-reset': passwordReset.render,
  'security-notice': securityNotice.render,
  'email-in-use-notice': emailInUseNotice.render,
  test: test.render,
};
