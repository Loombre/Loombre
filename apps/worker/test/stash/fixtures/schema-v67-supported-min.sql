...
-- Loombre :: apps/worker/test/stash/fixtures/schema-v67-supported-min.sql
--
-- Lower bound of the pinned supported range (STASH_SUPPORTED_SCHEMA_MIN =
-- 67, guard.ts). Schema shape as of Stash v0.27.0 (2024-09-23) — see this
-- directory's README.md for the full derivation. Notably: `folders` has
-- NO `basename` column at this version (added later at schema 84) — this
-- fixture exercises the read-model's fallback path for that.
--
...
INSERT INTO folders (id, path, parent_folder_id, mod_time, created_at, updated_at)
  VALUES (1, '/data/videos', NULL, '2023-06-01 00:00:00', '2023-06-01 00:00:00', '2023-06-01 00:00:00');
INSERT INTO folders (id, path, parent_folder_id, mod_time, created_at, updated_at)
  VALUES (2, '/data/videos/sub', 1, '2023-06-01 00:00:00', '2023-06-01 00:00:00', '2023-06-01 00:00:00');
