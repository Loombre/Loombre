...
> **Status:** version `0.9.0-rc.12`, pre-release. No published release has shipped yet.
...
| macOS | `.pkg` + menubar controller — Apple Silicon and Intel (Intel on a demand basis) | [docs/install/macos.md](docs/install/macos.md) |
