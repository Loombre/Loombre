...
> **Loombre is version `1.0.0-beta.3`, pre-release** — the tester line that
> began with beta.1 on 2026-09-03: packaged installers for Linux (`.rpm`,
> `.deb`, and the tarball), Windows, and macOS, Docker images on GHCR, and
> checksums, signatures, and build attestations for every file. Earlier
> betas are retired; only the current beta is published.
> **[Release page →](https://github.com/Loombre/Loombre/releases/tag/v1.0.0-beta.3)**
...
|---|---|---|
| **Docker Compose** (recommended) | `ghcr.io/loombre/loombre` + `ghcr.io/loombre/loombre-web`, tag `1.0.0-beta.3`, cosign-signed | [docs/install/docker.md](docs/install/docker.md) |
| **Linux** x64 | `.rpm` and `.deb` packages, or a tarball: systemd units, the `loombre` CLI, and a system-tray controller | [docs/install/linux.md](docs/install/linux.md) |
...
export LOOMBRE_IMAGE=ghcr.io/loombre/loombre:1.0.0-beta.3
export LOOMBRE_WEB_IMAGE=ghcr.io/loombre/loombre-web:1.0.0-beta.3
...
cosign verify \
  ...
  ghcr.io/loombre/loombre:1.0.0-beta.3
```
