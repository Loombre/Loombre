...
const ENV_ONLY_ENTRIES: SettingsRegistryEntry[] = [
  ...
  defineSetting({
    ...
    default: 3001,
    category: "network",
    description: "Which network port Loombre listens on for plain (non-HTTPS) connections. Not used once HTTPS is turned on below — that mode listens on its own port instead.",
...
const UI_ENTRIES: SettingsRegistryEntry[] = [
  ...
  defineSetting({
    ...
    default: 51820,
    category: "remote",
    description: "Which network port Loombre Remote uses for its secure tunnel connections. Changing this requires a server restart — already-connected devices would be disrupted otherwise.",
