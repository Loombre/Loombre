...
export const LOOMBRE_VERSION = "0.9.0-rc.8";
export const LOOMBRE_BUILD_MODE: "dev" | "release" = "dev";
export const LOOMBRE_GIT_SHORTHASH: string | null = "48624ce6";
...
export const LOOMBRE_VERSION_FULL = "0.9.0-rc.8-dev+48624ce6";
