// GENERATED — do not edit (node scripts/release/stamp-version.mjs)
//
...
export const LOOMBRE_VERSION = "1.0.0-beta.1";
export const LOOMBRE_BUILD_MODE: "dev" | "release" = "dev";
export const LOOMBRE_GIT_SHORTHASH: string | null = "cf1062ff";
...
export const LOOMBRE_VERSION_FULL = "1.0.0-beta.1-dev+cf1062ff";
