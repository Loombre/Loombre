...
export const LOOMBRE_VERSION = "0.9.0-rc.7";
export const LOOMBRE_BUILD_MODE: "dev" | "release" = "dev";
export const LOOMBRE_GIT_SHORTHASH: string | null = "7ee87c4f";
...
export const LOOMBRE_VERSION_FULL = "0.9.0-rc.7-dev+7ee87c4f";
